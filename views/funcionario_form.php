    ...
    <div class="container-flex">
        <div class="container">
            ...
            <form method="post" action="/assim_saude/funcionario/store" class="form-principal" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="formCpf" name="cpf" maxlength="14" required>
                </div>
    
                <div class="form-group">
                    <label for="formNascimento">Nascimento</label>
                    <input type="date" id="formNascimento" name="nascimento">
                </div>

                <div class="form-group">
                    <label for="formCep">CEP</label>
                    <input type="text" id="formCep" name="cep" maxlength="8" onblur="pesquisacep(this.value);">
                </div>

                <div class="form-group">
                    <label for="formUf">UF</label>
                    <input type="text" id="formUf" name="uf" maxlength="2">
                </div>

                <div class="form-group">
                    <label for="formCidade">Cidade</label>
                    <input type="text" id="formCidade" name="cidade" maxlength="150">
                </div>

                <div class="form-group">
                    <label for="formBairro">Bairro</label>
                    <input type="text" id="formBairro" name="bairro" maxlength="150">
                </div>

                <div class="form-group">
                    <label for="formLogradouro">Logradouro</label>
                    <input type="text" id="formLogradouro" name="logradouro" maxlength="200">
                </div>

                <div class="form-group">
                    <label for="formNumero">Número</label>
                    <input type="text" id="formNumero" name="numero" maxlength="10">
                </div>

                <div class="form-group">
                    <label for="formComplemento">Complemento</label>
                    <input type="text" id="formComplemento" name="complemento" maxlength="100">
                </div>

                <div class="form-group">
                    <label for="formEmail">Email</label>
                    <input type="email" id="formEmail" name="email" maxlength="150">
                </div>

                <div class="form-group">
                    <label for="formTelefone">Telefone</label>
                    <input type="text" id="formTelefone" name="telefone" maxlength="15">
                </div>
